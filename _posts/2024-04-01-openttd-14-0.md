...
As people don't like using cheats in the game, they are now called sandbox!
Same thing, different name.

A new setting has also been added, called "infinite money".
If this is enabled, you can spend as much money as you want without fear of bankruptcy or interest.
No more need to rescue yourself occasionally with the money cheat/sandbox.
And this setting works in multiplayer and with AIs too!

Your money balance is hidden from the status bar in "infinite money" mode, so you can concentrate on building a beautiful, sprawling network.
The real figures are still visible in the finances window.

Hopefully all this enables more people to play the game how they want to, without feeling punished for doing so.
